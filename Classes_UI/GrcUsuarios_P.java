...
public class GrcUsuarios_P extends javax.swing.JPanel {
    ...
    private void populaSeletorUsuario(){
        ...
        UImaster.UserBase.getUserList().forEach((u) -> {
    ...
    private void initComponents() {
        ...
        gerencUSR_Seletor.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
        ...
        mudarSenha_Button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mudarSenha_ButtonMouseClicked(evt);
            }
        });
        mudarSenha_Button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mudarSenha_ButtonActionPerformed(evt);
            }
        });
        ...
        excluirUSR_Button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                excluirUSR_ButtonMouseClicked(evt);
            }
        });
        excluirUSR_Button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        mudarID_Button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
        ...
        TornarADM_OPR_Button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(gerencUSR_Seletor, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(mudarID_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(mudarSenha_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(TornarADM_OPR_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(excluirUSR_Button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(gerencUSR_Seletor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(addUser_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void mudarSenha_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mudarSenha_ButtonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_mudarSenha_ButtonActionPerformed
    ...
    private void gerencUSR_SeletorPopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_gerencUSR_SeletorPopupMenuWillBecomeVisible
        this.populaSeletorUsuario();
    ...
    private void TornarADM_OPR_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TornarADM_OPR_ButtonMouseClicked
        ...
        if(UImaster.CurrentUser.isADM()){
            ...
            JOptionPane.showMessageDialog(null, "Você não tem permissão para realizar esta operação (Apenas Administradores)");
        }
        UImaster.UserBase.atualiza();
        gerencUSR_Seletor.repaint();
    }//GEN-LAST:event_TornarADM_OPR_ButtonMouseClicked

    private void gerencUSR_SeletorPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_gerencUSR_SeletorPopupMenuWillBecomeInvisible
    ...
    private void TornarADM_OPR_ButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TornarADM_OPR_ButtonMouseEntered
        Usuário selectedUser =  (Usuário)gerencUSR_Seletor.getSelectedItem();
        Usuário currentUser = UImaster.CurrentUser;
    ...
    private void excluirUSR_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_excluirUSR_ButtonMouseClicked
        Usuário selectedUser = (Usuário)gerencUSR_Seletor.getSelectedItem(); //usuário seleciondo na combobox
        ...
        if(currentUser.isADM()){      
            if( selectedUser.isADM() ){
                if(UImaster.UserBase.getADMcount() > 1){
                    ...
                    UImaster.UserBase.atualiza();
                    JOptionPane.showMessageDialog(null, "Usuário " + selectedUser + " Removido com Sucesso. Se você removeu o usuário logado atualmente, faça login novamente");
                    if(currentUser.equals(selectedUser)){
                        UImaster.reLogin();
                        SwingUtilities.getWindowAncestor(this).dispose(); //fecha essa janela de gerenciamentos de usuários.
                ...
                UImaster.UserBase.removerUsuário(selectedUser);
                UImaster.UserBase.atualiza();
                JOptionPane.showMessageDialog(null, "Usuário " + selectedUser + " Removido com Sucesso. Se você removeu o usuário logado atualmente o programa irá fechar");    
            }     
        }
        ...
        //Usuário logado não é ADM, limita oq ele pode fazer (somente remover a si próprio)
            ...
            if(selectedUser.equals(UImaster.CurrentUser)){
                UImaster.UserBase.removerUsuário(selectedUser);
                UImaster.UserBase.atualiza();
                JOptionPane.showMessageDialog(null, "Usuário " + selectedUser + " Removido com Sucesso. Faça login novamente");
                UImaster.reLogin();
                SwingUtilities.getWindowAncestor(this).dispose(); //fecha essa janela de gerenciamentos de usuários.
            }
            else{
                JOptionPane.showMessageDialog(null, "Apenas admnistradores podem modificar outros usuários.");
            }
        }
        gerencUSR_Seletor.repaint();
    }//GEN-LAST:event_excluirUSR_ButtonMouseClicked

    private void mudarSenha_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mudarSenha_ButtonMouseClicked
        Usuário selectedUser = (Usuário)gerencUSR_Seletor.getSelectedItem();
        String novaSenha;
    ...
    private void excluirUSR_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirUSR_ButtonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_excluirUSR_ButtonActionPerformed

    private void mudarID_ButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mudarID_ButtonMouseClicked
        // TODO add your handling code here:
        Usuário selectedUser = (Usuário) gerencUSR_Seletor.getSelectedItem();
        Usuário currentUser = UImaster.CurrentUser;
        ...
        if(currentUser.isADM()){
            ...
            if(newID.compareTo("") != 0 && newID != null){
                ...
                UImaster.menuPrincipal.updateUserNameLabel(newID);  //atualiza o "logado como" do menu principal
            ...
            if(selectedUser.equals(currentUser)){
                ...
                JOptionPane.showMessageDialog(null, "Somente admnistradores podem modificar outros usuários");
            }
