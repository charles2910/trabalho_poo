...
/**
 * Classe Principal que comandará a raíz da interface gráfica.
 * Ela contém também todos os recursos necessários para os elementos da UI
 * Rodarem, como a base de usuários, que se chamará UserBase, O usuário
 * Atualmente logado, "CurrentUser", dentre outros. Sua instanciação sempre
 * Será referida pelo nome "UImaster" por todos os elementos da interface.
...
public class UIGovernor_F extends JFrame{
    ...
    protected void reLogin(){  //método usado quando for necessário obrigar novo login (usuário logado se deletou)
